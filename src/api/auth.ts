...
import { SignInPayload, SignInResponse, IsMeResponse, SignUpPayload, SignUpResponse } from "../types/api/auth";
...
export const signIn: (payload: SignInPayload) => Promise<SignInResponse> = async (
  ...
  export const signUp: (payload: SignUpPayload) => Promise<SignInResponse> = async (
    payload
  ) => {
