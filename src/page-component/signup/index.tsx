...
const SignUp = () => {
    ...
    const [isFeaturesListActive, setIsFeaturesListActive] = useState<boolean>(false);
    ...
    const onButtonClick = (values: any) => {
        const {feature_ids, user_role, ...payload } = values;
                    ...
                    <Form>
                        <div className="bg-white shadow-md rounded px-8 pt-6 pb-8 mb-4 flex flex-col my-2">
                            <div className="w-full px-3 mb-6 md:mb-4">
                                <label className="text-grey-darker mb-2 font-bold" htmlFor="user_name">
                                    Username
                                </label>
                                <Field type="text" id="user_name" name="user_name" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" />
                            ...
                            <div className="w-full px-3 mb-6 md:mb-4">
                                ...
                                <Field
                                    ...
                                    >
                                    <option disabled={true} value="">Select A Role</option>
                                    <option key="client" value="client">Client</option>
                                    <option key="pilot_admin" value="pilot_admin">Pilot Admin</option>
                                </Field>
                            ...
                            <div className="w-full px-3 mb-6 md:mb-4">
                                ...
                                <ErrorMessage name="feature_ids" component="div" className="text-red-500 text-xs italic" />
                            </div>
                            )}
                            ...
                            {!isFeaturesListActive && (
                                ...
                                <Field name="pilot_id" as="select" className="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline">
                                    <option disabled={true} value="">Select A Pilot</option>
                            ...
                            {
                                isSuccess && (
                                    <Alert variant="filled" severity="success" className="mt-6 w-full mt-10 rounded-lg">
                                        {dataSignUp.meta}
                                        <br />
                                        Please&nbsp;
                                        <a href="/signin" className="text-blue-400 hover:text-orange-500 font-bold">
                                            click here 
                                        </a>
